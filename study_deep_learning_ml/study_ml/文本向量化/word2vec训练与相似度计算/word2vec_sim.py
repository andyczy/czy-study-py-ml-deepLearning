...
if __name__ == '__main__':
    model = gensim.models.Word2Vec.load('./study_ml/data/text_vector/zhiwiki_news.word2vec')
    p1 = './study_ml/data/text_vector/word2vec_P1.txt'
    p2 = './study_ml/data/text_vector/word2vec_P2.txt'
    p1_keywords = './study_ml/data/text_vector/word2vec_P1_keywords.txt'
    p2_keywords = './study_ml/data/text_vector/word2vec_P2_keywords.txt'
