...
import numpy as np
wordVectors = './study_ml/data/analysis/wordVectors.npy'
wordsList = './study_ml/data/analysis/wordsList.npy'
pos = './study_ml/data/analysis/pos/' 
neg = './study_ml/data/analysis/neg/' 
models = './study_ml/data/analysis/models/' 
idsMatrix =  './study_ml/data/analysis/idsMatrix.npy' 


# 互联网电影资料库（Internet Movie Database，简称IMDb）
wordsList = np.load(wordsList)
#  [b'0' b',' b'.' ... b'rolonda' b'zsombor' b'unk']
print('载入word列表',wordsList)
wordsList = wordsList.tolist()
wordsList = [word.decode('UTF-8') for word in wordsList]
wordVectors = np.load(wordVectors)
print('载入文本向量',wordVectors)
